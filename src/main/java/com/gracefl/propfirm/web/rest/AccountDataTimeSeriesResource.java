...
public class AccountDataTimeSeriesResource {
    ...
    public ResponseEntity<AccountDataTimeSeries> updateAccountDataTimeSeries(
        ...
        AccountDataTimeSeries result = accountDataTimeSeriesService.update(accountDataTimeSeries);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, accountDataTimeSeries.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/account-data-time-series/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<AccountDataTimeSeries> partialUpdateAccountDataTimeSeries(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, accountDataTimeSeries.getId().toString())
        );
    }
