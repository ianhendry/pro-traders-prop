...
public class Mt4AccountResource {
    ...
    public ResponseEntity<Mt4Account> updateMt4Account(
        ...
        Mt4Account result = mt4AccountService.update(mt4Account);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, mt4Account.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/mt-4-accounts/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Mt4Account> partialUpdateMt4Account(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, mt4Account.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Mt4Account>> getAllMt4Accounts(
        Mt4AccountCriteria criteria,
