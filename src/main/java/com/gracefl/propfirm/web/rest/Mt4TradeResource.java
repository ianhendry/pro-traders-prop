...
public class Mt4TradeResource {
    ...
    public ResponseEntity<Mt4Trade> updateMt4Trade(
        ...
        Mt4Trade result = mt4TradeService.update(mt4Trade);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, mt4Trade.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/mt-4-trades/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Mt4Trade> partialUpdateMt4Trade(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, mt4Trade.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<Mt4Trade>> getAllMt4Trades(
        Mt4TradeCriteria criteria,
