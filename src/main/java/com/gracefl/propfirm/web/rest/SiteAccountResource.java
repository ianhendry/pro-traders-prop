...
public class SiteAccountResource {
    ...
    public ResponseEntity<SiteAccount> updateSiteAccount(
        ...
        SiteAccount result = siteAccountService.update(siteAccount);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, siteAccount.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/site-accounts/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<SiteAccount> partialUpdateSiteAccount(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, siteAccount.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<SiteAccount>> getAllSiteAccounts(
        SiteAccountCriteria criteria,
