...
public class ChallengeTypeResource {
    ...
    public ResponseEntity<ChallengeType> updateChallengeType(
        ...
        ChallengeType result = challengeTypeService.update(challengeType);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, challengeType.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/challenge-types/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<ChallengeType> partialUpdateChallengeType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, challengeType.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<ChallengeType>> getAllChallengeTypes(
        ...
        Page<ChallengeType> page;
        if (eagerload) {
            page = challengeTypeService.findAllWithEagerRelationships(pageable);
        } else {
            page = challengeTypeService.findAll(pageable);
        }
