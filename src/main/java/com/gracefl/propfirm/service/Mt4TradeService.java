...
public interface Mt4TradeService {
     ...
     * Updates a mt4Trade.
     *
     * @param mt4Trade the entity to update.
     * @return the persisted entity.
     */
    Mt4Trade update(Mt4Trade mt4Trade);
    ...
    /**
     * Get all the mt4Trades with eager load of many-to-many relationships.
     *
     * @param pageable the pagination information.
     * @return the list of entities.
     */
    Page<Mt4Trade> findAllWithEagerRelationships(Pageable pageable);
