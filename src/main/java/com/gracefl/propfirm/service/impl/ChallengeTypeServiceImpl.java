...
public class ChallengeTypeServiceImpl implements ChallengeTypeService {
    ...
    @Override
    public ChallengeType update(ChallengeType challengeType) {
        log.debug("Request to save ChallengeType : {}", challengeType);
        return challengeTypeRepository.save(challengeType);
    }
    ...
    public Page<ChallengeType> findAllWithEagerRelationships(Pageable pageable) {
        return challengeTypeRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<ChallengeType> findOne(Long id) {
        ...
        return challengeTypeRepository.findOneWithEagerRelationships(id);
    }
