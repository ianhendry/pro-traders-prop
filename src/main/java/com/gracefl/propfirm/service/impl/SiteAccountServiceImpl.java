...
public class SiteAccountServiceImpl implements SiteAccountService {
    ...
    @Override
    public SiteAccount update(SiteAccount siteAccount) {
        log.debug("Request to save SiteAccount : {}", siteAccount);
        return siteAccountRepository.save(siteAccount);
    }
    ...
    public Page<SiteAccount> findAllWithEagerRelationships(Pageable pageable) {
        return siteAccountRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<SiteAccount> findOne(Long id) {
        ...
        return siteAccountRepository.findOneWithEagerRelationships(id);
    }
