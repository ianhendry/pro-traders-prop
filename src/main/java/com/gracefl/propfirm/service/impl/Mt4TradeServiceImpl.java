...
public class Mt4TradeServiceImpl implements Mt4TradeService {
    ...
    @Override
    public Mt4Trade update(Mt4Trade mt4Trade) {
        log.debug("Request to save Mt4Trade : {}", mt4Trade);
        return mt4TradeRepository.save(mt4Trade);
    }
    ...
    public Page<Mt4Trade> findAllWithEagerRelationships(Pageable pageable) {
        return mt4TradeRepository.findAllWithEagerRelationships(pageable);
    }
    ...
    public Optional<Mt4Trade> findOne(Long id) {
        ...
        return mt4TradeRepository.findOneWithEagerRelationships(id);
    }
