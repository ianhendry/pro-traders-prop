...
/**
 * Criteria class for the {@link com.gracefl.propfirm.domain.TradeChallenge} entity. This class is used
 * in {@link com.gracefl.propfirm.web.rest.TradeChallengeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /trade-challenges?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class TradeChallengeCriteria implements Serializable, Criteria {
    ...
    public TradeChallengeCriteria() {}

    public TradeChallengeCriteria(TradeChallengeCriteria other) {
    ...
    @Override
    public TradeChallengeCriteria copy() {
        return new TradeChallengeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TradeChallengeCriteria that = (TradeChallengeCriteria) o;
        return (
