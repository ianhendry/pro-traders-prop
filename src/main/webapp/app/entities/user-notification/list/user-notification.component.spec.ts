...
describe('UserNotification Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'user-notification', component: UserNotificationComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.userNotifications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
